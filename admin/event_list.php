                    ...
                    <div id="myModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" class="modal fade text-left">
                        <div role="document" class="modal-dialog modal-dialog-scrollable modal-lg">
                          <div class="modal-content">
                            ...
                            <form action="event_pref_save.php" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="form-group">
                                  <label>Date</label>
                                  <input name="event_date" type="date" placeholder="Enter event date..." class="form-control" required>
                                </div>

                                <div class="form-group">
                                  <label>Time</label>
                                  <input name="event_time" type="time" placeholder="Enter time date..." class="form-control" required>
                                </div>
                                ...
                                <div class="form-group">
                                  ...
                                  <input name="event_description" type="text" placeholder="Enter event description..." class="form-control" required>
                                </div>

                                <div class="form-group">
                                  <label>Category</label>
                                  <select name="event_category" placeholder="Enter event category..." class="form-control" required>
                                  <option>--Select Event Category--</option>
                                    <?php
$event_query = $conn->query("SELECT * FROM categories") or die(mysql_error());
while ($m_event_row = $event_query->fetch()) {?>
                                      <option value="<?php echo $m_event_row['category_id']; ?>"><?php echo $m_event_row['category']; ?></option>
                                  <?php }?>
                                  </select>
                                </div>
                                ...
                                <div class="form-group">
                                  <label>Flier</label>
                                  <input name="event_flier" type="file" placeholder="Enter event flier..." class="form-control" required>
                                </div>

                                <div class="form-group">
                                  <label>Organizer (NB: Can't be modified later)</label>
                                  <input name="event_organizer" type="text" placeholder="Enter event owner/host..." class="form-control" required>
                                </div>

                                <div class="form-group">
                                  <label>About Organizer</label>
                                  <input name="event_organizer_description" type="text" placeholder="Enter event owner/host description..." class="form-control" required>
                                </div>
                    ...
                    <div class="card-body">
                      <div class="table-responsive">
                        <table class="table table-striped" id="example">
                          ...
                          <?php $rowCtr = 0;
$event_query = $conn->query("SELECT * FROM events, categories, organizers WHERE events.event_category=categories.category_id AND events.event_id=organizers.event_id") or die(mysql_error());
while ($event_row = $event_query->fetch()) {
    ...
    ?>
                            ...
                            <tr>
                              ...
                              <td class="align-middle"><img src="../event-fliers/<?php echo $event_row['event_flier']; ?>" alt="<?php echo $event_row['event_title']; ?>" class="img-thumbnail" style="width:100px; height: 70px;"></td>
                              <td class="align-middle"><?php echo $event_row['event_title']; ?></td>
                              <td class="align-middle"><?php echo $event_row['event_date']; ?></td>
                              <td class="align-middle"><?php echo $event_row['event_time']; ?></td>
                              <td class="align-middle"><?php echo $event_row['event_venue']; ?></td>
                              <td class="align-middle"><?php echo $event_row['organizer_name']; ?></td>
                        ...
                        <div role="document" class="modal-dialog modal-dialog-scrollable modal-lg">
                          <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="form-group">
                                  <label>Time</label>
                                  <input value="<?php echo $event_row['event_time']; ?>" name="event_time" type="time" placeholder="Enter event time..." class="form-control" required>
                                </div>
                                ...
                                <div class="form-group">
                                  <label>Description</label>
                                  <input value="<?php echo $event_row['event_description']; ?>" name="event_description" type="text" placeholder="Enter event description..." class="form-control" required>
                                </div>

                                <div class="form-group">
                                  <label>Category</label>
                                  <select name="event_category" class="form-control" required>
                                    <option value="<?php echo $event_row['event_category']; ?>"><?php echo $event_row['category']; ?></option>
                                    <?php
$category_query = $conn->query("SELECT * FROM categories") or die(mysql_error());
    while ($category_row = $category_query->fetch()) {?>
                                ...
                                <div class="form-group">
                                  <label>Flier</label>
                                  <input value="<?php echo $event_row['event_flier']; ?>" name="event_flier" type="file" placeholder="Enter event flier..." class="form-control">
                                </div>
                        ...
                        <div role="document" class="modal-dialog modal-lg">
                          <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <?php echo "Time: " . $event_row['event_time']; ?><br />
