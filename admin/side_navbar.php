<!-- Side Navbar -->
        <nav class="side-navbar">
          ...
          <div class="sidebar-header d-flex align-items-center">
            <!-- <div class="avatar"><img src="../images/logo1.png" alt="..." class="img-fluid rounded-circle"></div> -->
            <!-- <div class="title">
          ...
          <ul class="list-unstyled">
            ...
            <li><a href="list_tickets.php?seat_id="> <i class="icon-form"></i>Sold Tickets </a></li>
