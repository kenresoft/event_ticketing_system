...
if ($num_row == 0) {
    if ($conn->query("INSERT INTO `users`(`lastname`, `firstname`, `password`, `email`, `phone`)
    VALUES ('$lastname', '$firstname', '$final_pass', '$email', '$phone')")) {
        echo "<script>window.location = 'login.php?status=success';</script>";
    } else {?>
    <script>window.location = 'login.php?status=failed';</script>
    <?php }
} else {
    if (isset($_POST['register'])) {
        $notice = "User Already Exists! <br>";
    }
    ?>
          ...
          <div class="col-md-7">
            <div class="card-body">
              ...
              <form action="#" method="post">
                  ...
                  <input name="register" id="register" class="btn btn-block login-btn mb-4" type="submit" value="SignUp">
                </form>
                <a href="#!" class="forgot-password-link">Forgot password?</a>
                <p class="login-card-footer-text">Already have an account? <a href="login.php" class="text-reset">Login here</a></p>
